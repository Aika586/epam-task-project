Feature: Authentication
  ...
  Scenario: Email is already registered
    ...
    Then I should see an error message "Email is already in use"
  ...
  Scenario: Missing required fields
    Given I am on the sign up page
    When I attempt to register without providing an required fields
    Then I should see an error message "Email and password are required"
    And the missing fields should be highlighted
    And I should remain on the sign-up page

  Scenario Outline: Missing required fields during sign up
    Given I am on the sign up page
    When I attempt to register with <email> and <password>
